...
{
    //Scenes
    public const int SCENE1 = 1; //Ejemplo numeraci�n escenas
    ...
    public const int MAX_CLICKS_POTATOPEELER = 32; //numero de clicks que hay que hacer en el boton en el minijuego de pelar la patata
    ...
    //PatataPong
    public const int PONG_BALL_START_SPEED = 3;
